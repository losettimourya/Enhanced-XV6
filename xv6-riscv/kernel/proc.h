...
struct proc
{
  ...
  uint pbsrtime;    // Stores the number of ticks it was running since last scheduled
  uint pbsstime;   // Stores the number of ticks it was sleeping since last scheduled
  ...
  int integermask;             // Stores the trace mask
  uint timeofcreation;             // Stores the tick on when it was created
